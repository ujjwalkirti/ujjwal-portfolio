	...
	return (
		<main className="bg-[#0a192f] min-h-screen">
			<Head>
				...
				<meta name="description" content="Ujjwal Kirti's portfolio - Software Engineer experienced in Kubernetes, CI/CD, AWS, and cloud-native tooling." />
				<meta name="viewport" content="width=device-width, initial-scale=1" />
				<link rel="icon" href="/UK.png" />

				{/* Open Graph Tags */}
				<meta property="og:title" content="Ujjwal Kirti | Software Engineer Portfolio" />
				<meta property="og:description" content="Portfolio of Ujjwal Kirti, showcasing expertise in Scalable systems, DevOps, automation, cloud infrastructure, and CI/CD pipelines." />
